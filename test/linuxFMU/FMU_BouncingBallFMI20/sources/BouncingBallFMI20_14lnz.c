...
const char *BouncingBallFMI20_linear_model_frame()
{
  ...
  "\n"
  "  Real 'x_h' = x[1];\n""  Real 'x_v' = x[2];\n"
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_BouncingBallFMI20;\n";
}
const char *BouncingBallFMI20_linear_model_datarecovery_frame()
{
