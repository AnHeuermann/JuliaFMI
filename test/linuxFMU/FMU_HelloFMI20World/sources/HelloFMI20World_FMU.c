...
#define MODEL_IDENTIFIER HelloFMI20World
#define MODEL_GUID "{f7d1f815-44cb-4aac-88bc-2fcbf3078152}"
...
extern void HelloFMI20World_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc HelloFMI20World_setupDataStruc
